    ...
    this.setState({ fullScreen: !this.state.fullScreen }, () => {
      Orientation.getOrientation((e, orientation) => {
        if (this.state.fullScreen) {
          ...
          if (this.props.rotateToFullScreen) {
            if (orientation !== 'LANDSCAPE') {
              // There is a bug where you can rotate an iPhone
              // to portrait mode whilst in full screen, and
              // the Orientation module will now report the
              // device orientation as portrait.
              // So let's force landscape mode first.
